"""
Prompt Templates for Concept Normalization Workflow

This module contains prompts for finding and validating similar concepts
that should be merged into canonical forms.
"""
...
# =============================================================================
# CONCEPT NORMALIZATION PROMPT (Find Similar Concepts by Name)
# =============================================================================
...
# =============================================================================
# MERGE VALIDATION PROMPT (Validate with Definitions)
# =============================================================================
