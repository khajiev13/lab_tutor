...
def generate_report(
    ...
    report_lines.extend([
        ...
        "relationships to both `CONCEPT` and `TEACHER_UPLOADED_DOCUMENT` nodes. This dual-anchoring enables "
        ...
        f"- **Questions Linked to TEACHER_UPLOADED_DOCUMENT Nodes:** {neo4j_stats.get('questions_linked_to_theories', 0)}",
        f"- **Fully Linked Questions (CONCEPT ↔ QUIZ_QUESTION ↔ TEACHER_UPLOADED_DOCUMENT):** {neo4j_stats.get('fully_linked_questions', 0)}",
        ...
        f"- **Unique Documents with Questions:** {neo4j_stats.get('unique_theories_with_questions', 0)}",
        "",
