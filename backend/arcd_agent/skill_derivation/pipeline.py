...
from src.skill_derivation.clustering import find_optimal_k
from src.skill_derivation.embedder import embed_concepts, extract_concepts
from src.skill_derivation.llm_validator import should_recluster, validate_clusters
from src.skill_derivation.models import CourseSkillMap, SkillCluster
from src.skill_derivation.prerequisite import (
...
class SkillDerivationPipeline:
    ...
    def run(self, course_id: str | None = None) -> CourseSkillMap:
        ...
        # LLM validation loop
        for _iteration in range(MAX_RECLUSTER_ITERATIONS):
