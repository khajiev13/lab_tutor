...
class SkillConcept(BaseModel):
    ...
    description: str = Field(description="1-2 sentence definition grounded in the chapter")
...
class Skill(BaseModel):
    ...
    description: str = Field(description="What the student can DO after mastering this skill")
...
class ChapterSkillsResult(BaseModel):
    ...
    chapter_summary: str = Field(description="2-3 sentence summary of the chapter's main topics")
