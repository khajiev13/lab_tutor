"""Visual Content Evaluator — self-contained service.

Wraps the shared resource pipeline with VCE-specific config (prompts, weights,
YouTube-focused search). Provides a single entry point for fetching video resources.
"""
...
def fetch_videos_for_skill(
    skill: SkillProfile,
    *,
    progress: ProgressCallback | None = None,
) -> list[tuple[CandidateResource, ResourceScore, float]]:
    """Run the full video discovery pipeline for a single skill.
